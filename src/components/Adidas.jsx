...
const Adidas =() =>{
    ...
    return(
        <div className ="max-w-md border border-gray-200 rounder-lg p-6 shadow-sm">
            <img src="src\assets\Image\s5.png" alt="adidas" ></img>
            <div className="mb-4">
            ...
            <p className =" text-2xl front-bold mb-6">$98.99</p>
            <div className="mb-6">
                <p className ="text-sm front-medium">Quantity</p>
                ...
                <button onClick={handleIncrease} className="px-3 py-1 text-lg hover:bg-gray-500 transition">+</button>
            </div>
